...
def main():
	...
	if rank == 0:
		...
		dset_orientations = f.create_dataset("orientations", shape=(numPatterns,)+(numParticles, 4), dtype=np.float32, chunks=(1,)+(numParticles, 4), compression="gzip", compression_opts=4)
